...
import { FaBox, FaShippingFast, FaCheck, FaSpinner, FaFileDownload, FaSearch, FaPen } from "react-icons/fa";
  ...
  const OrderCard = ({ order }) => (
    <div
      onClick={() => {
        ...
        setIsModalOpen(true); // Open modal when clicking on the order card
      }}
        ...
        <div className="text-right">
          ...
          <div  onClick={(e) => {
            ...
            <select
              ...
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full p-2 focus:outline-none"
            >
